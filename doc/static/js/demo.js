...
$(function () {
    ...
    $tooltips.tooltip({
        ...
        positionOffset: {
            top: '0',
            left: '0',
        },          // tooltip相对偏移位置，e.g:{top: 2px, left: 2px}，其值可为负数
        $container: false,                   // 展示放置tooltip的容器
        template: '<div class="tooltip-wrap" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
